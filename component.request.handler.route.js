...
component.load({ moduleName: "component.logging", gitUsername: "marchuanv" }).then(({ logging }) => {
    component.load({ moduleName: "component.request.handler", gitUsername: "marchuanv" }).then(({ config }) => {
        for(const route of routes){
            route.host = config.hostname;
